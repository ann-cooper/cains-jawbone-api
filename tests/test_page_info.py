...
from src.project.resources import PageInfoHandler
...
class TestPageInfo:
    ...
    def test_post_page_info_new(self, app, client, clean_test_tables, page_form_test_data):
    ...
    def test_post_info_update(self, app, client, clean_test_tables, page_form_test_data):
